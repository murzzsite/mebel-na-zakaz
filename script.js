(() => {
  const LEAD_ENDPOINT = 'https://lead-relay.leestygpt.workers.dev/lead/FYAW4B96EX';
  ...
  const targets = document.querySelectorAll('.adv, .srv, .step, .work-card, .contact-card, .faq__item, .form-wrap, .hero__card, .hero__stat');
